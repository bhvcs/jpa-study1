...
public class QOrder extends EntityPathBase<Order> {
    ...
    private static final long serialVersionUID = -447283679L;
    ...
    public final EnumPath<jpaStudy.jpaShop.domain.status.OrderStatus> status = createEnum("status", jpaStudy.jpaShop.domain.status.OrderStatus.class);
